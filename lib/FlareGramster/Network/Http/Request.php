 ...
 * @version    1.0.0
 */
namespace FlareGramster\Network\Http;

use FlareGramster\Storage\ImmutableKeyValue;
...
{
    /**
     * @var \FlareGramster\Storage\ImmutableKeyValue The GET variables
     */
    private $getVariables;

    /**
     * @var \FlareGramster\Storage\ImmutableKeyValue The POST variables
     */
    private $postVariables;

    /**
     * @var \FlareGramster\Storage\ImmutableKeyValue The SERVER variables
     */
    private $serverVariables;

    /**
     * @var \FlareGramster\Storage\ImmutableKeyValue The FILES variables
     */
     ...
     * Creates instance
     *
     * @param \FlareGramster\Storage\ImmutableKeyValue $getVariables    The GET variables
     * @param \FlareGramster\Storage\ImmutableKeyValue $postVariables   The POST variables
     * @param \FlareGramster\Storage\ImmutableKeyValue $serverVariables The SERVER variables
     * @param \FlareGramster\Storage\ImmutableKeyValue $filesVariables  The FILES variables
     */
